...
public class Class_Trasmisibles extends Activity {
...
//		finish();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		llenar_spinner();
//		spinSubgrupo.setPopupBackgroundResource(R.drawable.btnactores);
	...
	{
		try{
			subgrupos=baseDatos.consultar_nombres_subgrupos("TRANSMISIBLES");
		}
		catch(Exception e)
		{
